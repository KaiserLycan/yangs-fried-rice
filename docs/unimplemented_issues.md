...
## Issue #23: US-13: Customer Order Tracking
...
## Issue #22: US-12: Order Review & Flexible Payment Options
- [ ] **Still Needed:** Customers must be able to review their complete order details (name, date, address, items ordered, estimated completion time, and amount payable) before confirming the placement.
- [ ] **Still Needed:** Customers must be able to choose a payment method before finalizing their order.
- [ ] **Still Needed:** The system must support cash on delivery and in-store payments as standard checkout options alongside digital payments.
...
## Issue #11: US-05: Driver Operations & Proof of Delivery
...
- [ ] **Still Needed:** The system must require and accept **proof of delivery** (e.g. photo upload, signature) when an order is marked as delivered.
...
## Issue #5: US-03: Menu Browsing & Checkout
- [ ] **Still Needed:** The system automatically calculates the total cost, including delivery fees.
- [ ] **Still Needed:** The checkout process requires selecting between pickup or delivery options.
