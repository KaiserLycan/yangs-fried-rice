...
export default function KdsPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#efe6d8]">
      {/* Header */}
      <div className="bg-[#b8352a] border-[#2e2523] border-b flex gap-[20px] items-center px-[24px] py-[18px] shrink-0 w-full z-10 shadow-sm">
        ...
        <div className="flex flex-col items-start ml-2">
          <div className="font-display text-[22px] tracking-[0.44px] whitespace-nowrap leading-none">
        ...
        <div className="flex flex-col items-end text-right justify-center">
          <p className="font-bold text-[#fbf6ec] text-[10px] tracking-[1.4px] leading-none mb-1">IN QUEUE</p>
          <p className="font-display text-[#f0b27a] text-[22px] leading-none">{inQueue}</p>
        </div>
        
        <div className="flex flex-col items-end text-right justify-center ml-2">
          <p className="font-bold text-[#fbf6ec] text-[10px] tracking-[1.4px] leading-none mb-1">AVG PREP</p>
          <p className="font-display text-[#f0b27a] text-[22px] leading-none">{avgPrep}</p>
        </div>
      </div>
